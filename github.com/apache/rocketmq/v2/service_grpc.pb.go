...
type MessagingServiceClient interface {
	...
	PullMessage(ctx context.Context, in *PullMessageRequest, opts ...grpc.CallOption) (MessagingService_PullMessageClient, error)
...
func (c *messagingServiceClient) PullMessage(ctx context.Context, in *PullMessageRequest, opts ...grpc.CallOption) (MessagingService_PullMessageClient, error) {
	stream, err := c.cc.NewStream(ctx, &MessagingService_ServiceDesc.Streams[1], "/apache.rocketmq.v2.MessagingService/PullMessage", opts...)
	if err != nil {
		return nil, err
	}
	x := &messagingServicePullMessageClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type MessagingService_PullMessageClient interface {
	Recv() (*PullMessageResponse, error)
	grpc.ClientStream
}

type messagingServicePullMessageClient struct {
	grpc.ClientStream
}

func (x *messagingServicePullMessageClient) Recv() (*PullMessageResponse, error) {
...
func (c *messagingServiceClient) UpdateOffset(ctx context.Context, in *UpdateOffsetRequest, opts ...grpc.CallOption) (*UpdateOffsetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/apache.rocketmq.v2.MessagingService/UpdateOffset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messagingServiceClient) GetOffset(ctx context.Context, in *GetOffsetRequest, opts ...grpc.CallOption) (*GetOffsetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/apache.rocketmq.v2.MessagingService/GetOffset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messagingServiceClient) QueryOffset(ctx context.Context, in *QueryOffsetRequest, opts ...grpc.CallOption) (*QueryOffsetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/apache.rocketmq.v2.MessagingService/QueryOffset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messagingServiceClient) Telemetry(ctx context.Context, opts ...grpc.CallOption) (MessagingService_TelemetryClient, error) {
	stream, err := c.cc.NewStream(ctx, &MessagingService_ServiceDesc.Streams[2], "/apache.rocketmq.v2.MessagingService/Telemetry", opts...)
	if err != nil {
		return nil, err
	}
...
type MessagingServiceServer interface {
	...
	PullMessage(*PullMessageRequest, MessagingService_PullMessageServer) error
...
func (UnimplementedMessagingServiceServer) PullMessage(*PullMessageRequest, MessagingService_PullMessageServer) error {
...
func _MessagingService_PullMessage_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MessagingServiceServer).PullMessage(m, &messagingServicePullMessageServer{stream})
}

type MessagingService_PullMessageServer interface {
	Send(*PullMessageResponse) error
	grpc.ServerStream
}

type messagingServicePullMessageServer struct {
	grpc.ServerStream
}

func (x *messagingServicePullMessageServer) Send(m *PullMessageResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _MessagingService_UpdateOffset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apache.rocketmq.v2.MessagingService/UpdateOffset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MessagingService_GetOffset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apache.rocketmq.v2.MessagingService/GetOffset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MessagingService_QueryOffset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apache.rocketmq.v2.MessagingService/QueryOffset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
